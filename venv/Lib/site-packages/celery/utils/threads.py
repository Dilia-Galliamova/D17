...
def release_local(local):
    ...
    With this function one can release :class:`locale` objects as well as
...
class _LocalStack:
    ...
    This class works similar to a :class:`locale` but keeps a stack
...
class LocalManager:
    """locale objects cannot manage themselves.
