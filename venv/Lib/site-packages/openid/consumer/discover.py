...
def findOPLocalIdentifier(service_element, type_uris):
    """Find the OP-locale Identifier for this xrd:Service element.
    ...
    @returns: The OP-locale Identifier for this service element, if one
        is present, or None otherwise.
    @rtype: str or unicode or NoneType
    """
    # XXX: Test this function on its own!

    # Build the list of tags that could contain the OP-locale Identifier
    local_id_tags = []
